...
namespace GDAuth {
    ...
    inline std::string doPost(const std::string& path, const std::map<std::string, std::string>& params) {
        ...
        curl_easy_setopt(curl, CURLOPT_USERAGENT, "GeometryDash/2.11");
    ...
    inline std::string getScores(const std::string& accountID, const std::string& gjp2, const std::string& levelID) {
